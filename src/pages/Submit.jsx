...
export default function Submit( { setVisible }) {
    ...
    return (
        <div className='block'>
          ...
          <button onClick={handleAnalyticsClick} className='block mx-auto my-10 w-1/5 h-16 text-2xl border-black border-2 rounded-xl bg-gradient-to-tr from-blue-600 to-sky-400 p-2 cursor-pointer transition duration-300 hover:opacity-90'>See Analytics</button>
        </div>
      )
}